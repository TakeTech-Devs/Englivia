...
public class Session {
    ...
    public static final String IS_FIRST_COUNT = "isFirstCount";
    ...
    public static int getFirstNCount(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getInt(IS_FIRST_COUNT, 0);
    }
