package com.englivia.quiz.fragment;
...
public class ReviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bgreentick=view.findViewById(R.id.bgreentick);
        ...
        if (btnOpt1.getText().toString().equalsIgnoreCase(wrongAns)) {
            layout_A.setBackgroundColor(getResources().getColor(R.color.red));

           // layout_A.setBackgroundResource(R.drawable.wrong_gradient);
        } else if (btnOpt2.getText().toString().equalsIgnoreCase(wrongAns)) {
            layout_B.setBackgroundColor(getResources().getColor(R.color.red));
        } else if (btnOpt3.getText().toString().equalsIgnoreCase(wrongAns)) {
            layout_C.setBackgroundColor(getResources().getColor(R.color.red));
        } else if (btnOpt4.getText().toString().equalsIgnoreCase(wrongAns)) {
            layout_D.setBackgroundColor(getResources().getColor(R.color.red));
        } else if (btnOpt5.getText().toString().equalsIgnoreCase(wrongAns)) {
            layout_E.setBackgroundColor(getResources().getColor(R.color.red));
        }
