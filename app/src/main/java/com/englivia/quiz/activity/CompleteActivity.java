...
public class CompleteActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //System.out.println("----test : " + Constant.ADMOB_INTERSTITIAL);
        //System.out.println("----test : " + Constant.cate_name);

      /*  AdRequest adRequest = new AdRequest.Builder().build();
        InterstitialAd.load(this, Constant.ADMOB_INTERSTITIAL, adRequest, new InterstitialAdLoadCallback() {
            @Override
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                interstitialAd.show(CompleteActivity.this);
            }
...
*/
        ...
        Log.e("id"
                ,"jhbh1");
        Log.e("id"
                ,getIntent().getStringExtra("learning_id"));
