        ...
        ApiConfig.RequestToVolley((result, response) -> {
            ...
            if (result) {
                try {
                    ...
                    System.out.println("Responsesub::=" + Constant.subCategoryId);
                    System.out.println("Responsesub::=" + Constant.CATE_ID);
                    ...
                    if (!error) {
                        ...
                        if (Constant.CATE_ID.equals("25")){
                            Collections.sort(subCateList, new SubCategory.Sortbyroll());
                        } else if (Constant.CATE_ID.equals("28")){
                            Collections.sort(subCateList, new SubCategory.SortbyrollError());
                        } else {
                            Collections.sort(subCateList, new SubCategory.Sortbyroll());
                            //Collections.reverse(subCateList);
                        }
    ...
    public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.ItemRowHolder> {
        ...
        public void onBindViewHolder(@NonNull SubCategoryAdapter.ItemRowHolder holder, final int position) {
            ...
            holder.relativeLayout.setOnClickListener(v -> {
                ...
                intent.putExtra("isErrorCat", true);
